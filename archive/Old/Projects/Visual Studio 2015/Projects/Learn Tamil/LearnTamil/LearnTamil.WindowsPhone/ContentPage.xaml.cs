                        ...
                        if (elementName == "section")
                        {
                            ...
                            if (reader.HasAttributes)
                            {
                                ...
                                else if (reader.GetAttribute("header") != null)
                                {
                                    ...
                                    tempPanel.Margin = new Thickness(5, 10, 5, 10);
                                    tempPanel.VerticalAlignment = VerticalAlignment.Center;
                                    tempPanel.HorizontalAlignment = HorizontalAlignment.Center;
                                    Grid grd = new Grid();
                                ...
                                else if (reader.GetAttribute("activity") != null)
                                {
                                    if (reader.GetAttribute("activity") == "match")
                                    {
                                        ...
                                        StackPanel stkPanel = new StackPanel();
                                        stkPanel.Margin = new Thickness(10, 5, 10, 5);
