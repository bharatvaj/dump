...
namespace LearnTamil
{
    public class DrawerLayout : Grid
    {
        ...
        private TextBlock _testTextBlock;
        ...
        public void InitializeDrawerLayout()
        {
            ...
            try
            {
                ...
                _testTextBlock = _listFragment.Children.OfType<TextBlock>().FirstOrDefault();
            }
            catch(Exception ex)
            {
            ...
            if (_listFragment.Width != 400)
                _listFragment.Width = Window.Current.Bounds.Width > Window.Current.Bounds.Height ? (Window.Current.Bounds.Height * 0.85) : (Window.Current.Bounds.Width * 0.85);
