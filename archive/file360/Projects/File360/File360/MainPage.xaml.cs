...
namespace File360
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            if (themeHold == System.Windows.Visibility.Visible)
            {
                ...
                apps.SideBarColor = "{StaticResource PhoneSemitransparentBrush}";
            }
            #endregion
    ...
    private void sdcard_menu_Tap(object sender, System.Windows.Input.GestureEventArgs e)
    {
        ...
        StateHelper();
        MoveViewWindow(-420);
        sdText.Foreground = App.Current.Resources["PhoneBackgroundBrush"] as SolidColorBrush;
        sdImage.Fill = App.Current.Resources["PhoneBackgroundBrush"] as SolidColorBrush;
        Blurer.Visibility = System.Windows.Visibility.Collapsed;
    }
